...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io-f-022-009
case title: 基础IO-JBOD-Raid5-大小IO混合-随机写
test category: JBOD和VD并行IO
check point: 基础IO-JBOD-Raid5-大小IO混合-随机写
...
class BasicioJbodRaidParallelRandomWrite(BasicioMultipleRaidScriptBase):
...
def main() -> None:
    BasicioJbodRaidParallelRandomWrite.run()
