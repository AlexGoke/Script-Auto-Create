...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io-f-021-017
case title: 基础IO-JBOD-JBOD-大IO-顺序混合读写
test category: 两个JBOD并行IO
check point: 基础IO-JBOD-JBOD-大IO-顺序混合读写
...
class BasicioJbodJbodparallelSequentialReadWrite(BasicioMultipleRaidScriptBase):
...
def main() -> None:
    BasicioJbodJbodparallelSequentialReadWrite.run()
