...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io-f-022-002
case title: 基础IO-JBOD-Raid5-大IO-随机读
test category: JBOD和VD并行IO
check point: 基础IO-JBOD-Raid5-大IO-随机读
...
class BasicioJbodRaidParallelRandomRead(BasicioMultipleRaidScriptBase):
...
def main() -> None:
    BasicioJbodRaidParallelRandomRead.run()
