...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io-f-020-002
case title: 基础IO-Raid1-Raid5-并行大IO-随机读
test category: 两个VD并行IO
check point: 基础IO-Raid1-Raid5-并行大IO-随机读
...
class BasicioRaid1Raid5parallelRandomRead(BasicioMultipleRaidScriptBase):
