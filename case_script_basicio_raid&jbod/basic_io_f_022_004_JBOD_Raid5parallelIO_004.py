...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io-f-022-004
case title: 基础IO-JBOD-Raid5-小IO-顺序读
test category: JBOD和VD并行IO
check point: 基础IO-JBOD-Raid5-小IO-顺序读
...
class BasicioJbodRaidParallelSequentialRead(BasicioMultipleRaidScriptBase):
