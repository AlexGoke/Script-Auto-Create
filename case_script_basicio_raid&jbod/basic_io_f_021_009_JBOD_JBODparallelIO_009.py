...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io-f-021-009
case title: 基础IO-JBOD-JBOD-大小IO混合-随机写
test category: 两个JBOD并行IO
check point: 基础IO-JBOD-JBOD-大小IO混合-随机写
...
class BasicioJbodJbodparallelRandomWrite(BasicioMultipleRaidScriptBase):
...
def main() -> None:
    BasicioJbodJbodparallelRandomWrite.run()
