...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io-f-001-007
case title: 基础IO-JBOD-多种大小IO混合-顺序读
test category: JBOD-基础IO
check point: 基础IO-JBOD-多种大小IO混合-顺序读
...
@steps: 1、组建JBOD
        ...
        读写比例rdpct=100，xfersize=（2K，64K，128M，256M）测试并发顺序读，
        3、清理环境
