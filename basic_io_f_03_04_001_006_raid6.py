...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io_f-03-04-002-006
case title: 基础IO-Raid6-多种IO满条带非满条带混合-顺序读
test category: Raid6
...
读写比例rdpct=100，xfersize=（67K，128K，3071K，8192K）测试并发顺序读，
3、清理环境
@changelog
"""
...
class BasicioRaid6SequenceRead(BasicioMultiVDScriptBase):
    ...
    def set_parameters(cls) -> None:
        ...
        # vdbench数据块大小
        cls.vdbench_parameters_dict[constants.VDB_XFERSIZE] = '(67K,25,128K,25,3071K,25,8192K,25)'
        # 读写比例
