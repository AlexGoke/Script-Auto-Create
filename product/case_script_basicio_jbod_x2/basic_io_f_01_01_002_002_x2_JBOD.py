...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io_f-01-01-002-002
case title: 基础IO-JBOD-多种大IO-顺序读
test category: x2口JBOD
check point: x2口-JBOD顺序读正常
...
读写比例rdpct=100，xfersize=（10M，64M，128M，256M）测试并发顺序读，
3、清理环境
...
class BasicioJbodSequenceRead(BasicioJBODScriptBase):
