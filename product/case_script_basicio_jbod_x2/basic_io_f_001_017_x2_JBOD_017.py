...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io-f-001-017
case title: 基础IO-JBOD-多种小IO-随机混合读写
test category: JBOD-基础IO
check point: 基础IO-JBOD-多种小IO-随机混合读写
...
@steps: 1、组建JBOD
        ...
        读写比例rdpct=70，xfersize=（2K，16K，32K，64K）测试并发随机混合读写，
        3、清理环境
...
class BasicIOJbodRandomReadWrite(BasicioJBODScriptBase):
    ...
    def set_parameters(cls):
        ...
        # 测试数据块大小及分配设置
        cls.vdbench_parameters_dict['xfersize'] = '(2K,25,16K,25,32K,25,64K,25)'
        # vdbench一致性校验
...
def main() -> None:
    BasicIOJbodRandomReadWrite.run()
