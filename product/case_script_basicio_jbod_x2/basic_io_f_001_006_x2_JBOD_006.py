...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io-f-001-006
case title: 基础IO-JBOD-多种大IO-顺序读
test category: JBOD-基础IO
check point: 基础IO-JBOD-多种大IO-顺序读
...
@steps: 1、组建JBOD
        ...
        读写比例rdpct=100，xfersize=（16M，64M，128M，256M）测试并发顺序读，
        3、清理环境
