...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io-f-001-022
case title: 基础IO-JBOD-多种大IO-顺序混合读写
test category: JBOD-基础IO
check point: 基础IO-JBOD-多种大IO-顺序混合读写
...
@steps: 1、组建JBOD
        ...
        读写比例rdpct=70，xfersize=（8M，64M，128M，256M）测试并发顺序混合读写，
        3、清理环境
