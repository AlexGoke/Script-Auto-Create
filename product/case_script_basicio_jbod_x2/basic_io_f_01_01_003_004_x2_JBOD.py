...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io_f-01-01-003-004
case title: 基础IO-JBOD-起始位对齐模式-随机写
test category: x2口JBOD
check point: x2口-JBOD随机写正常
...
随机比例seekpct=0，读写比例rdpct=0，xfersize=（1K，64K，128M，256M）测试并发随机写，
3、清理环境
