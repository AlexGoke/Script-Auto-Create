...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io-f-014-035
case title: 基础IO-SAS-SSD-单一IO小于单条带-顺序写
test category: SAS-SSD-基础IO
check point: 基础IO-SAS-SSD-单一IO小于单条带-顺序写
...
@steps: 1、组建符合条件的VD后进行快速初始化
        ...
        读写比例rdpct=0，xfersize=1K测试并发顺序写，
        3、进行数据一致性校验
        4、清理环境
...
class BasicioSasSsdSequentialWrite(BasicioMultiVDScriptBase):
    ...
    def set_parameters(cls):
        ...
        # 测试数据块大小及分配设置
        cls.vdbench_parameters_dict['xfersize'] = '1k'
        # vdbench一致性校验
