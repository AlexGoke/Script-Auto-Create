...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io-f-014-026
case title: 基础IO-SAS-SSD-多种IO满多条带-随机写
test category: SAS-SSD-基础IO
check point: 基础IO-SAS-SSD-多种IO满多条带-随机写
...
@steps: 1、组建符合条件的VD后进行快速初始化
        ...
        读写比例rdpct=0，xfersize=（768K， 1536K， 2304K， 3072K）测试并发随机写，
        3、进行数据一致性校验
        4、清理环境
...
class BasicioSasSsdRandomWrite(BasicioMultiVDScriptBase):
    ...
    def set_parameters(cls):
        ...
        # 测试数据块大小及分配设置
        cls.vdbench_parameters_dict['xfersize'] = '(768K,25, 1536K,25, 2304K,25, 3072K,25)'
        # vdbench一致性校验
