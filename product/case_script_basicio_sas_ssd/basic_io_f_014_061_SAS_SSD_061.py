...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io-f-014-061
case title: 基础IO-SAS-SSD-多种IO满条带非满条带混合-顺序混合读写
test category: SAS-SSD-基础IO
check point: 基础IO-SAS-SSD-多种IO满条带非满条带混合-顺序混合读写
...
@steps: 1、组建符合条件的VD后进行快速初始化
        ...
        读写比例rdpct=40，xfersize=（64K， 384K， 1024K， 4000K）测试并发混合读写，
        3、进行数据一致性校验
        4、清理环境
...
class BasicioSasSsdSequentialReadWrite(BasicioMultiVDScriptBase):
    ...
    def set_parameters(cls):
        ...
        # 测试数据块大小及分配设置
        cls.vdbench_parameters_dict['xfersize'] = '(64K,25, 384K,25, 1024K,25, 4000K,25)'
        # vdbench一致性校验
