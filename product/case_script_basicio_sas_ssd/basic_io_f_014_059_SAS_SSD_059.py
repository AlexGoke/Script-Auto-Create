...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io-f-014-059
case title: 基础IO-SAS-SSD-多种IO满多条带-顺序混合读写
test category: SAS-SSD-基础IO
check point: 基础IO-SAS-SSD-多种IO满多条带-顺序混合读写
...
@steps: 1、组建符合条件的VD后进行快速初始化
        ...
        读写比例rdpct=60，xfersize=（3072K， 6144K， 9216K， 15360K）测试并发混合读写，
        3、进行数据一致性校验
        4、清理环境
...
class BasicioSasSsdSequentialReadWrite(BasicioMultiVDScriptBase):
    ...
    def set_parameters(cls):
        ...
        # 测试数据块大小及分配设置
        cls.vdbench_parameters_dict['xfersize'] = '(3072K,25, 6144K,25, 9216K,25, 15360K,25)'
        # vdbench一致性校验
