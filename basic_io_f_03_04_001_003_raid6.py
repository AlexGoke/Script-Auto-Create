...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io_f-03-04-002-003
case title: 基础IO-Raid6-单一IO大于单条带-顺序读
test category: Raid6
...
读写比例rdpct=100，xfersize=200K测试并发顺序读，
3、清理环境
@changelog
"""
...
class BasicioRaid6SequenceRead(BasicioMultiVDScriptBase):
    ...
    def set_parameters(cls) -> None:
        ...
        # vdbench数据块大小
        cls.vdbench_parameters_dict[constants.VDB_XFERSIZE] = '200k'
        # 读写比例
