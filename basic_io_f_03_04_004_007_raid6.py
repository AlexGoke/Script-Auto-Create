...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io_f-03-04-004-007
case title: 基础IO-Raid6-多种小IO-顺序写
test category: Raid6
...
读写比例rdpct=0，xfersize=（31K， 67K， 137K， 255K）测试并发顺序写，
3、进行数据一致性校验
4、清理环境
...
class BasicioRaid6SequenceWrite(BasicioMultiVDScriptBase):
    ...
    def set_parameters(cls) -> None:
        ...
        # vdbench数据块大小
        cls.vdbench_parameters_dict[constants.VDB_XFERSIZE] = '(31K,25,67K,25,137K,25,255K,25)'
        # 读写比例
