...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io_f-06-01-002-002
case title: 基础IO-Raid1-Raid5-并行大IO-顺序读
test category: Raid1和Raid5并行IO
check point: Raid1-Raid5-并行顺序读正常
...
class BasicioRaid1_Raid5SequenceRead(BasicioMultipleRaidScriptBase):
    ...
    def set_parameters(cls):
        ...
        # vdbench数据块大小
        cls.vdbench_parameters_dict[constants.VDB_XFERSIZE] = '(913K,25,4096K,25,10M,25,256M,25)'
        # 读写比例 读：100；写：0
...
def main() -> None:
    BasicioRaid1_Raid5SequenceRead.run()
