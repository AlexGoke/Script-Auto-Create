...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io_f-03-04-004-005
case title: 基础IO-Raid6-多种IO非满多条带-顺序写
test category: Raid6
...
读写比例rdpct=0，xfersize=（1000K， 2000K， 3000K， 4000K）测试并发顺序写，
3、进行数据一致性校验
4、清理环境
...
class BasicioRaid6SequenceWrite(BasicioMultiVDScriptBase):
    ...
    def set_parameters(cls) -> None:
        ...
        # vdbench数据块大小
        cls.vdbench_parameters_dict[constants.VDB_XFERSIZE] = '(1000K,25,2000K,25,3000K,25,4000K,25)'
        # 读写比例
