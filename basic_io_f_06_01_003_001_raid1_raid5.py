...
# -*- coding:utf-8 -*-
"""
case number: ps3-v1.0.0-basic_io_f-06-01-003-001
case title: 基础IO-Raid1-Raid5-并行小IO-随机写
test category: Raid1和Raid5并行IO
check point: Raid1-Raid5-并行随机写正常
...
读写比例rdpct=0，xfersize=（1K，128K， 256K， 512K）测试并发随机写，
3、进行数据一致性校验
4、清理环境
@changelog:
"""
...
class BasicioRaid1_Raid5RandomWrite(BasicioMultipleRaidScriptBase):
    ...
    def set_parameters(cls):
        ...
        # vdbench数据块大小
        cls.vdbench_parameters_dict[constants.VDB_XFERSIZE] = '(1K,25,128K,25,256K,25,512K,25)'
        # 读写比例 读：100；写：0
...
def main() -> None:
    BasicioRaid1_Raid5RandomWrite.run()
